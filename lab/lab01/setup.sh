...
ip netns exec clab-lab01-pc03 ip addr add 192.168.0.4/24 dev eth1
...
ip netns exec clab-lab01-pc03 ip route del default
...
ip netns exec clab-lab01-pc03 ip route add default via 192.168.0.1 dev eth1